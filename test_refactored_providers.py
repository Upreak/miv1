#!/usr/bin/env python3
"""
Test Script for Refactored Provider Implementation

This script validates that the refactored provider implementations
match the successful patterns from test_all_apis.py.
"""
...
# Import the refactored providers
from Backend.backend_app.brain_module.providers.openrouter_provider import OpenRouterProvider
from Backend.backend_app.brain_module.providers.grok_provider import GrokProvider
from Backend.backend_app.brain_module.providers.gemini_provider import GeminiProvider
from Backend.backend_app.brain_module.providers.metrics_tracker import MetricsTracker
from Backend.backend_app.brain_module.providers.config_manager import ProviderConfigManager

# Test resume prompt (same as in test_all_apis.py)
RESUME_PROMPT = """
...
the knowledge about the whole process of the company and to know the  financial activities of the company.  
